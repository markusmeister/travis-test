...
```{python testfig3, echo='TRUE', out.width='33%', fig.align='center', fig.cap = 'This is a live figure from mibPy code'}
...
```{r testfig4, echo = FALSE, out.width='33%', fig.align='center', fig.cap = 'This is a figure from an image file'}
knitr::include_graphics(file.path(projdir, "img/testfig1.pdf"))
```

Can cite this as Fig \@ref(fig:testfig4).
