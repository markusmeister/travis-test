...
\usepackage{hyperref}
\hypersetup{
            pdftitle={A Test of integrating bookdown with Travis CI},
            pdfauthor={Markus Meister},
            pdfborder={0 0 0},
            breaklinks=true}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# connect to python}
\KeywordTok{library}\NormalTok{(reticulate)}
\NormalTok{matplotlib <-}\StringTok{ }\KeywordTok{import}\NormalTok{(}\StringTok{"matplotlib"}\NormalTok{)}
\NormalTok{matplotlib}\OperatorTok{$}\KeywordTok{use}\NormalTok{(}\StringTok{"Agg"}\NormalTok{, }\DataTypeTok{force =} \OtherTok{TRUE}\NormalTok{) }\CommentTok{# backend that doesn't expect a display}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{```\{python testfig1, echo=FALSE, out.width='33%', fig.align='center', fig.cap = 'A figure from Python code'\}}
\NormalTok{plt.plot([0, 2, 1, 4])}
\NormalTok{plt.show()}
\NormalTok{```}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.33\linewidth]{/home/travis/build/markusmeister/travis-test/bookdown-demo_files/figure-latex/testfig1-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{```\{r testfig2, echo=FALSE, out.width='33%', fig.align='center', fig.cap='A figure from a PDF file.'\}}
\NormalTok{knitr::include_graphics('img/testfig1.pdf')}
\NormalTok{```}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.66\linewidth]{/home/travis/build/markusmeister/travis-test/bookdown-demo_files/figure-latex/plotP1-1} 
